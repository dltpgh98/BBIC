...
public class Map_Find_way extends Maps_Activity {
    ...
    private JSONObject odsayResult;


    public JSONObject getOdsayResult() {
        return odsayResult;
    }

    public void setOdsayResult(JSONObject odsayResult) {
        this.odsayResult = odsayResult;
    }
        ...
        public void onSuccess(ODsayData odsayData, API api) {
            try{
                if(api == API.SEARCH_PUB_TRANS_PATH){
                    setOdsayResult(odsayData.getJson().getJSONObject("result"));
//                    System.out.println(result+"=============호출 내===================");
