...
public class NewKakaoFriend {
    ...
    public NewKakaoFriend(int partyCode, String partyName, String promissTime, long userCode, String promiseAddress, int partyStatus, String friendCode, String friendName, String friendProfile) {
        this.partyCode = partyCode;
        this.partyName = partyName;
        this.promissTime = promissTime;
        this.partyStatus = partyStatus;
